...
vim.lsp.util.open_floating_preview = function(contents, syntax, opts, ...)
    local new_opts = opts and vim.tbl_deep_extend("force", {}, opts) or {}
    new_opts.border = new_opts.border or BORDER_ROUNDED
    local bufnr, winnr = orig_util_open_floating_preview(contents, syntax, new_opts, ...)
...
vim.env.PATH = table.concat({
    vim.fn.expand(NPM_GLOBAL_BIN),
    vim.fn.expand(LOCAL_BIN),
    vim.fn.expand(MASON_BIN),
    vim.env.PATH,
}, "")
