...
vim.api.nvim_set_hl(0, "NoicePopupBorder", { bg = NONE, fg = "#27a1b9", blend = 0, force = true })

vim.api.nvim_set_hl(0, "NoicePopupBorderSearch", { bg = NONE, fg = "#27a1b9", blend = 0, force = true })
vim.api.nvim_set_hl(0, "NoicePopupBorderInput", { bg = NONE, fg = "#27a1b9", blend = 0, force = true })
vim.api.nvim_set_hl(0, "NoicePopupTitleSearch", { bg = NONE, fg = "#27a1b9", blend = 0, force = true })
vim.api.nvim_set_hl(0, "NoicePopupTitleInput", { bg = NONE, fg = "#27a1b9", blend = 0, force = true })
vim.api.nvim_set_hl(0, "BlinkCmpDocSeparator", { bg = "#1a1b26", blend = 0, force = true })
vim.api.nvim_set_hl(0, "Pmenu", { bg = "#1a1b26", blend = 0, force = true })
vim.api.nvim_set_hl(0, "NoicePopupmenuBorder", { bg = NONE, fg = "#27a1b9", blend = 0, force = true })
...
vim.api.nvim_set_hl(0, "BlinkCmpDocBorder", { fg = "#27a1b9", bg = COLOR_BACKGROUND_PRIMARY, force = true })
